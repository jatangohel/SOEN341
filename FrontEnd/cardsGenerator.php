...
function cardDisp($i)
{
  ...
  echo
  '<a class="card card-body text-center height:400px" id="hello" href="weeklyschdulef.php?semIndex=';echo"$i";echo "&semYear=";echo $semYearFE[$i]; echo"&semName="; echo $semNameFE[$i]; echo'"class="custom-card" style="background: #F8C471">'.
  '<thead>'.
