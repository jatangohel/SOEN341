<?php
var_dump($_SESSION['numCoursesYearTerm']);
$x=current($_SESSION['numCoursesYearTerm']);
...
#center-now {
 ...
 <body>
	<div class="container">
    	...
    	<a href="javascript:showhide('constraintform')">
    		    <div class="col text-center">
   			 <h2 type="button" class="btn btn-primary" id="centernow">Add Costraints</h2>
   			 	</div>
    	</a>

    	<div id="constraintform" style="display:none;">
