...
if (isset($_POST['profilestatus'])) {
	...
	if ($_POST['UserName'] != "" ) {
		$update = "UPDATE users SET `UserName`='".$_POST['UserName']."' WHERE `UserId`=".$UserId;
		mysqli_query($conn,$update);
	}

	if ($_POST['Email'] != "") {
		$update = "UPDATE users SET `Email`='".$_POST['Email']."' WHERE `UserId`=".$UserId;
		mysqli_query($conn,$update);
	...
	if ($_POST['Password'] != "") {
		...
		$update = "UPDATE users SET `Password`='".$_POST['Password']."' WHERE `UserId`=".$UserId;
		mysqli_query($conn,$update);
	}
