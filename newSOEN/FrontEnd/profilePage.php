...
<div class="infobox">
      ...
      <form action="#" method="POST">
        <div class="form-group">
          ...
          ?>
          <input type="hidden" class="form-control" name="profilestatus" value="1"> 
          <input type="text" class="form-control" name="UserName">
          <input type="hidden" class="form-control" name="UserId" value="<?php echo $res['UserId']; ?>">
        </div>
        <div class="form-group">
        ...
        <button type="submit" class="btn btn-success" value="changepassword">Submit</button>
      </form>
