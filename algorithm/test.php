...
<body>
  <div>
    ...
    $math203_L1 = new Lecture (0,"MATH203","A",1000,1115,array("M","W"),
		"F", null, null, false, false, 3);
    $math203_L = new Lecture (0,"MATH203","A",1000,1115,array("M","W"),
    "F", null, null, false, false, 3);
    ...
    "F", array($math203_L1, $math204_L1), null, true, false, 3);
...
///////////////
    ...
    $comp232_T1 = new Tut (2,"COMP232", "DD", 2030, 2210, array("W"),
      "DA");
